      ...
      <div className="verify-email__card">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="verify-email__body">Your account is now active. You can sign in.</p>
            <Link to="/login" className="verify-email__signin-link">Sign In</Link>
          </>
        )}
        {status === 'error' && (
          <>
            ...
            <p className="verify-email__body">{message}</p>
            <Link to="/login" className="verify-email__back-link">Back to Sign In</Link>
          </>
        )}
      </div>
    </div>
